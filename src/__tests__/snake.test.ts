...
describe('Snake Game', () => {
  ...
  it('should move snake right on game-tick', () => {
    ...
    state = reducer(state, Actions.create['game-tick'](null));
  ...
  it('should change direction', () => {
    let state = initialState;
    state = reducer(state, Actions.create['change-direction']('down'));
    expect(selectDirection(state)).toBe('down');
  });

  it('should prevent 180 degree turns', () => {
    let state = initialState; // direction: right
    state = reducer(state, Actions.create['change-direction']('left'));
  ...
  it('should set gameOver on wall collision', () => {
    ...
    state = reducer(state, Actions.create['change-direction']('up'));
    state = reducer(state, Actions.create['game-tick'](null));
  ...
  it('should reset game on start-game', () => {
    let state = initialState;
    state = reducer(state, Actions.create['game-tick'](null));
    state = reducer(state, Actions.create['start-game'](null));
